          ...
          {done ? (
            <div className="text-center py-4">
              ...
              <p className="text-blue-300 text-sm leading-relaxed mb-6">
                An admin will review and approve your access. Once approved, you can sign in
                with your credentials.
              </p>
              <div className="bg-white/10 rounded-xl p-4 text-left mb-6">
                <p className="text-white/60 text-xs uppercase tracking-wider mb-1">Registered as</p>
                <p className="text-white font-medium">{form.name}</p>
                <p className="text-blue-300 text-sm">{form.email}</p>
              </div>
              <Link
                to="/login"
                className="inline-block w-full text-center bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 rounded-lg transition-colors"
              >
                Back to Sign In
              </Link>
            </div>
            ...
            <>
              ...
              <p className="text-white/40 text-xs mb-5">Access requires admin approval after registration.</p>
              ...
              <p className="text-center text-white/50 text-sm mt-6">
                ...
                <Link to="/login" className="text-blue-300 hover:text-blue-200">Sign in</Link>
              </p>
            </>
          )}
        </div>
